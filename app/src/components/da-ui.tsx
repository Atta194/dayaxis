...
/* ---------- SVG stick-figure poses for exercises ---------- */
const POSES: Record<string, ReactNode> = {
  stand: <><circle cx="60" cy="18" r="9" fill="#1E7A6B" /><path d="M60 27v34M60 40 44 52m16-12 16 12M60 61 47 82m13-21 13 21" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  reach: <><circle cx="60" cy="18" r="9" fill="#1E7A6B" /><path d="M60 27v34M60 36 42 14m18 22 18-22M60 61 47 82m13-21 13 21" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  armsout: <><circle cx="60" cy="18" r="9" fill="#1E7A6B" /><path d="M60 27v34M60 36 36 30m24 6 24-6M60 61 46 82m14-21 14 21" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  jump: <><circle cx="60" cy="14" r="9" fill="#1E7A6B" /><path d="M60 23v26M60 32 40 20m20 12 20-12M60 49 44 70m16-21 16 21M44 70h-8m28 0h8" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  squat: <><circle cx="60" cy="14" r="9" fill="#1E7A6B" /><path d="M60 23v20M60 34 40 30m20 4 20-4M60 43 44 70m16-27 14 27M42 72h-6m30 0h6" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  plank: <><circle cx="98" cy="26" r="9" fill="#1E7A6B" /><path d="M90 32 40 92M90 32 90 50m0 0-50 60M20 92h18" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  lunge: <><circle cx="60" cy="14" r="9" fill="#1E7A6B" /><path d="M60 23v24M60 36 42 26m18 10 20 10M60 47 46 78m14-31 16 19M46 78 34 90m28-12-2 24" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  bridge: <><circle cx="78" cy="20" r="9" fill="#1E7A6B" /><path d="M72 26 40 58m32-32 26 22M40 58 24 84m16-26-10 22M66 80l14-24" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  chair: <><path d="M26 84h68M30 84v14m60-14v14M40 60v24m40-24v24" stroke="#8B9891" strokeWidth="4" strokeLinecap="round" /><circle cx="60" cy="16" r="9" fill="#1E7A6B" /><path d="M60 25v25M60 34 42 26m18 8 18-8M60 50v18" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  wall: <><path d="M96 24 88 96" stroke="#8B9891" strokeWidth="4" /><circle cx="60" cy="20" r="9" fill="#1E7A6B" /><path d="M60 29v36M60 40 78 28m18 6-18 12M60 65 44 88m16-23 16 23" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  march: <><circle cx="60" cy="16" r="9" fill="#1E7A6B" /><path d="M60 25v30M60 34 40 30m20 4 22 4M60 55 44 74m16-19 16 19M44 74l-8 12" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
  bear: <><circle cx="86" cy="24" r="9" fill="#1E7A6B" /><path d="M78 30 34 78M78 30 70 78M34 78H22m48 0h8" stroke="#24312D" strokeWidth="5" strokeLinecap="round" /></>,
};

export function Pose({ pose }: { pose: string }) {
  return (
    <svg viewBox="0 0 120 100" width="130" height="108" role="img" aria-label="Exercise posture">
      <rect width="120" height="100" rx="12" fill="var(--card2)" />
